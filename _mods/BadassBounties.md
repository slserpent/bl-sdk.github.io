...
title: Badass Bounties # Title of the mod
version: "1.0" # Version of the mod
supported: "BL2" # Supported games; currently can only display as "BL2", "BL2 + TPS", or "TPS"

tagline: "Adds Bounties to the game." # A short description of the mod itself.
description: "Adds Bounties to the game." # This is set in order to keep the SEO proper
longDescription: "Adds many randomly generated bounties to the game.\nEach bounty will reward you with XP, Money and a random item upon completion.\nThe rarity of the reward items scale with your level.\nTo open the bounty board menu check your modded keybinds menu.\n\nYou can reroll your active bounties at any time for the cheap price of 2 Eridium per bounty that is not completed." # Description of what the mod can do
