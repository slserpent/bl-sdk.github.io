...
description: "Trivia Minigame for BL2" # This is set in order to keep the SEO proper
longDescription: "Trivia minigame for BL2, With easy and hard difficulties. Requires MapLoader and UserFeedback" # Description of what the mod can do
