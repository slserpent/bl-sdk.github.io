...
description: "Allows skipping dialog" # This is set in order to keep the SEO proper
longDescription: "Allows dialog to be skipped by pressing a keybind, defaults to Z.\nAdditionally, allows for the option to automatically skip all dialog so it never plays." # Description of what the mod can do
