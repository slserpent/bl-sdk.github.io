...
requirements: ['Coroutines >= 1.1', 'UEMath Library >= 1.3'] # Requirements for the given mod
requirementTitles: ['Coroutines', 'UEMathLibrary'] # The link-friendly name of the requirements
