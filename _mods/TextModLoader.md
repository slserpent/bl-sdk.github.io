...
description: "Displays Text Mods from binaries in the SDK mods menu." # This is set in order to keep the SEO proper
longDescription: "Displays Text Mods from binaries in the SDK mods menu." # Description of what the mod can do
